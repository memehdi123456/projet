...
def main():
        ...
        quiz.add_question(Question("Quel est le nom du système d'exploitation mobile d'Apple ?", ["Android", "iOS", "Windows Mobile"], "c"))
        ...
        quiz.add_question(Question("Quelle est la couleur de la première Apple logo ?", ["Vert", "Arc-en-ciel", "Noir"], "c"))
